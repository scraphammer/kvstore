...
function PostBeginPlay() {
  ...
  if (!bPostBPInitialized) {
    ...
    kvStoreSetter.OperationScope = KvStoreSetter.EOperationScopeType.OS_PERSONAL;
    ...
    kvStoreSetter.OperationType = KvStoreSetter.EOperationType.OT_SET;
    kvStoreSetter.OperationScope = KvStoreSetter.EOperationScopeType.OS_GLOBAL;
    kvStoreChecker = spawn(class'KvStoreChecker');
